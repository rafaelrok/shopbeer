...
public class CidadesImpl implements CidadesQueries {
	...
	private Long total(com.algaworks.brewer.repository.filter.CityFilter filtro) {
		Criteria criteria = manager.unwrap(Session.class).createCriteria(Cidade.class);
		adicionarFiltro(filtro, criteria);
	...
	private void adicionarFiltro(com.algaworks.brewer.repository.filter.CityFilter filtro, Criteria criteria) {
		if (filtro != null) {
