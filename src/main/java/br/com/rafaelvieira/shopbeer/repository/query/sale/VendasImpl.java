...
public class VendasImpl implements VendasQueries {
	...
	@Override
	public Page<Venda> filtrar(com.algaworks.brewer.repository.filter.SaleFilter filtro, Pageable pageable) {
	...
	private Long total(com.algaworks.brewer.repository.filter.SaleFilter filtro) {
		Criteria criteria = manager.unwrap(Session.class).createCriteria(Venda.class);
		adicionarFiltro(filtro, criteria);
	...
	private void adicionarFiltro(com.algaworks.brewer.repository.filter.SaleFilter filtro, Criteria criteria) {
